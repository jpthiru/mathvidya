...
# EC2 Application Security Group - Direct access (no ALB)
resource "aws_security_group" "app" {
  ...
  # HTTP from anywhere (direct access without ALB)
  ingress {
    description = "HTTP from anywhere"
    from_port   = 80
    to_port     = 80
  ...
  # HTTPS from anywhere (for future SSL on EC2)
  ingress {
    description = "HTTPS from anywhere"
    from_port   = 443
    to_port     = 443
...
# =============================================================================
# ALB RESOURCES - COMMENTED OUT TO SAVE COSTS
# Uncomment when ready to use ALB with ACM certificate
# =============================================================================
...
# -----------------------------------------------------------------------------
# ACM Certificate for HTTPS - COMMENTED OUT (not needed without ALB)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Application Load Balancer - COMMENTED OUT TO SAVE COSTS
# -----------------------------------------------------------------------------
...
# ACM Certificate Validation - COMMENTED OUT (not needed without ALB)
